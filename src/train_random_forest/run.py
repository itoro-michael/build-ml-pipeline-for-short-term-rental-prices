...
def go(args):
    ...
    # Select cols of type object
    list_object_cols = X_val.select_dtypes(include=['object']).columns.tolist()
    X_val[list_object_cols] = X_val[list_object_cols].astype(str)
...
def get_inference_pipeline(rf_config, max_tfidf_features):
    ...
    # and a step called "random_forest"
